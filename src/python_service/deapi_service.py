...
DEFAULT_DEAPI_MUSIC_MODEL = os.getenv("DEAPI_MUSIC_MODEL", "AceStep_1_5_Base")
DEFAULT_DEAPI_MUSIC_FORMAT = os.getenv("DEAPI_MUSIC_FORMAT", "wav")
DEFAULT_DEAPI_INFERENCE_STEPS = int(os.getenv("DEAPI_INFERENCE_STEPS", "40"))
DEFAULT_DEAPI_GUIDANCE_SCALE = float(os.getenv("DEAPI_GUIDANCE_SCALE", "7"))
